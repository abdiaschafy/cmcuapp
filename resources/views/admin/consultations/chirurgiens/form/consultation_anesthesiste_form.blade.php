...
@csrf
    ...
    <tr>
        ...
        <td class="form-group small">
            <div class="form-check">
                <input class="form-check-input" tabIndex="1" type="radio" id="anesthesi_salle" name="anesthesi_salle[]" value="Ambulatoire" {{ (old( 'anesthesi_salle')=='Ambulatoire' ) ? 'checked' : '' }}> Ambulatoire
            </div>
            <div class="form-check">
                <input class="form-check-input" tabIndex="1" type="radio" id="anesthesi_salle" name="anesthesi_salle[]" value="Urgence" {{ (old( 'anesthesi_salle')=='Urgence' ) ? 'checked' : '' }}> Urgence
            </div>
            <div class="form-check">
                <input class="form-check-input" tabIndex="1" type="radio" id="anesthesi_salle" name="anesthesi_salle[]" value="Entrée le jour de l'intervention" {{ (old( 'anesthesi_salle')=='Entrée le jour de l\' intervention ') ? 'checked ' : ' ' }}> Entrée le jour de l'intervention </div>
            <div class="form-check">
                <input class="form-check-input" tabIndex="1" type="radio" id="anesthesi_salle" name="anesthesi_salle[]" value="Hospit < 10 jours" {{ (old( 'anesthesi_salle')=='Hospit < 10 jours' ) ? 'checked' : '' }}> Hospit < 10 jours
            </div>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>
            ...
            <div class="form-check">
                <input type="checkbox" class="form-check-input" value="Oui" name="jeune_preop[]"> Solides :
                {{ Form::text('solide', null, ['class' => 'offset-2 mb-1 ml-10', 'placeholder' => ' H-']) }}
            </div>
            <div class="form-check">
                <input type="checkbox" class="form-check-input" value="Non" name="jeune_preop[]"> Liquides clairs :
                {{ Form::text('liquide', null, ['class' => 'offset-1 ml-4', 'placeholder' => ' H-']) }}
            </div>
    ...
    <tr>
        ...
        <td class="form-group small">
            <div class="form-check">
                <input class="form-check-input" tabIndex="1" type="checkbox" id="technique_anesthesie" name="technique_anesthesie[]" value="Anesthésie générale" {{ (old( 'technique_anesthesie[]')=='Anesthésie' ) ? 'checked' : '' }}> Anesthésie générale
            </div>
            <div class="form-check">
                <input class="form-check-input" tabIndex="1" type="checkbox" id="technique_anesthesie" name="technique_anesthesie[]" value="Sédation" {{ (old( 'technique_anesthesie[]')=='Sédation' ) ? 'checked' : '' }}> Sédation
            </div>
            <div class="form-check">
                <input class="form-check-input" tabIndex="1" type="checkbox" id="technique_anesthesie" name="technique_anesthesie[]" value="Rachidienne" {{ (old( 'technique_anesthesie[]')=='Rachidienne' ) ? 'checked' : '' }}> Rachidienne
            </div>
            <div class="form-check">
                <input class="form-check-input" tabIndex="1" type="checkbox" id="technique_anesthesie" name="technique_anesthesie[]" value="Péridurale" {{ (old( 'technique_anesthesie[]')=='Péridurale' ) ? 'checked' : '' }}> Péridurale
            </div>
            <div class="form-check">
                <input class="form-check-input" tabIndex="1" type="checkbox" id="technique_anesthesie" name="technique_anesthesie[]" value="ALR" {{ (old( 'technique_anesthesie[]')=='ALR' ) ? 'checked' : '' }}> ALR
            </div>
            <div class="form-check">
                <input class="form-check-input" tabIndex="1" type="checkbox" id="technique_anesthesie" name="technique_anesthesie[]" value="Locale" {{ (old( 'technique_anesthesie[]')=='Locale' ) ? 'checked' : '' }}> Locale
            </div>
